async function fetchFolderContents(path = "") {
  ...
  async function generateProjectTree(folder = "Deeper", parentElement = null) {
    try {
      ...
      // Create a container for the current folder
      ...
      contents.forEach((item) => {
        ...
        if (item.type === "dir") {
          // If it's a folder, create a collapsible section
      ...
      // Append the container to the parent element or document body
      if (parentElement) {
